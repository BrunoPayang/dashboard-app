...
const DashboardPage: React.FC = () => {
  ...
  const dashboardCards = [
    {
      title: 'Étudiants',
      description: 'Gérer les dossiers d\'étudiants, les inscriptions et les informations',
      icon: <PeopleIcon sx={{ fontSize: 40, color: schoolColors.primary }} />,
      action: 'Voir les Étudiants',
      path: '/students',
      color: schoolColors.primaryLight,
    },
    {
      title: 'Gestion des Paiements',
      description: 'Suivre les paiements des étudiants, les frais et les dossiers financiers',
    ...
    },
    {
      ...
      description: 'Configurer les paramètres de l\'école, les classes et la structure académique',
      icon: <SchoolIcon sx={{ fontSize: 40, color: schoolColors.secondary }} />,
      action: 'Gérer l\'École',
      path: '/settings',
      color: schoolColors.secondaryLight,
    },
    {
      title: 'Rapports et Analyses',
      description: 'Générer des rapports et voir les analyses de performance des étudiants',
    ...
    },
    {
      ...
      description: 'Configurer les préférences du tableau de bord et les options du système',
